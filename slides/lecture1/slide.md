...
- はてなブックマーク
  - 見てる人が多い
  - いろんな情報源を横断して見られる
- 技術知見共有サイト (Zenn, Stack Overflow など)
...
<!--元のPowerPointでは無効化されているページなのでコメントアウト-->
<!--
---
...
- HTML/CSS/JavaScriptのみで書かれたもの
- 2010年代初頭ぐらいまではこれが主流
- 完全に静的なコンテンツは今は見つけるほうが難しい
  - 阿部寛のサイトぐらい

## 動的コンテンツ(Dynamic Contents)
- 「状態」が変わりうるもの
- 自分で入力・検索ができる
- TwitterやAmazonなども動的コンテンツ
...
traQには400万以上のメッセージとそれに付随するスタンプ情報、タグ、ユーザー情報などが保存されています。
