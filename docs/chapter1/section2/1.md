...
<<< @/chapter1/section2/src/1/index.html

#### counter.js

<<< @/chapter1/section2/src/1/counter.js

:::info
GoやC++などでは`""`と`''`が区別されますが、JavaScriptでは区別されません。
:::
...
<<< @/chapter1/section2/src/1/App.vue

##### src/components/HelloWorld.vue

`script`タグ内で`ClickCounter.vue`を読み込み、`template`タグ内にカウンターを配置します。

<<< @/chapter1/section2/src/1/HelloWorld.vue

##### src/components/ClickCounter.vue

<<< @/chapter1/section2/src/1/ClickCounter.vue
