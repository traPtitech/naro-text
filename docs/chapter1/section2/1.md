...
`~/develop/vue`ディレクトリを作成してその中にテンプレートリポジトリをクローンしてプログラムを書きます。
...
```bash
mehm8128@DESKTOP-6F4C0KI ~/vue/todolist-mehm8128 (main)$ npm i
...
```bash
mehm8128@DESKTOP-6F4C0KI ~/vue/todolist-mehm8128 (main)$ npm run dev
