...
:::info
GitHub Codespaces を使っている場合、自己紹介のページを他の人に対して公開できます。ポートタブを開いて、 Private になっている部分を右クリック、ポートの表示範囲からPublicを選択してみましょう。左側に表示されているアドレスを共有すれば、他の人からもページを確認できるようになります！

ただし、こうして共有されたURLは、 **Codespaces を停止させるとアクセスできなくなる**ことに注意が必要です。
